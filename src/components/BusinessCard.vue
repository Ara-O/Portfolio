<template>
  <div
    class="business-card-container border px-10 py-12 border-stone-900 rounded-md h-[270px] w-auto max-w-[500px] relative"
  >
...
.business-card-container {
  background: linear-gradient(300deg, #141414, #050505);
}
</style>
