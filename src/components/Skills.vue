    ...
    <section class="flex flex-wrap justify-between mt-20">
      ...
      <section>
        ...
        <h5 class="w-auto max-w-[30rem] font-['Poppins'] leading-7 text-md font-light mt-7">
          ...
          programs I have had with JOURNi, Accenture, Google, and the Kapor Center. I have
          experience with HTML, CSS, Javascript and Vue.js. I also have with experience in back-end
